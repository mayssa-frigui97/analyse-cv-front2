...
import { CountCompetences, CountFormation, findAllCompetences } from '../../../shared/Cv/query';
...
export class DashboardComponent implements OnInit {
    ...
    this.apollo
      ...
      .subscribe((data) => {
        ...
        this.poles.forEach(pole => {
          ...
          console.log("label:",this.doughnutChartLabelsPole)
          console.log("list:",list)
        });
        console.log("list2:",list)
        this.doughnutChartDataPole=[list];
        console.log("datachart:",this.doughnutChartDataPole)
      });
  }
    ...
    this.apollo
      ...
      .subscribe((data) => {
        ...
        this.equipes.forEach(equipe => {
          ...
          console.log("label:",this.doughnutChartLabelsEquipe)
          console.log("list:",list)
        });
        console.log("list2:",list)
  ...
  statisCompetences() {
    this.apollo
      ...
      .subscribe(({data}) => {
        ...
        this.changeNombre(5);
        console.log("slice barChartData:",this.barChartData)
        console.log("slice barChartLabels:",this.barChartLabels)
      });
  }
  ...
  getCompetences(): Competence[] {
    ...
    .query<any>({
      ...
      .subscribe(({data}) => {
        this.listCompetences = data.findAllCompetences;
